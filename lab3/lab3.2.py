...
edit3 = Entry(width=15)
edit4 = Entry(width=15)
edit5 = Entry(width=15)
edit6 = Entry(width=15)

button1 = Button(text="Порахувати", width=30, bg="#0BA5BE", fg="white")
...
label2['text'] = "Блювота :"
label3 = Label()
label3['text'] = "Жовтушність :"
label4 = Label()
label4['text'] = "Напади болю в правому підребер'ї :"
label5 = Label()
label5['text'] = "Збільшення печінки :"
label6 = Label()
label6['text'] = "Апетит :"
label7 = Label()
label7['text'] = "Результат ймовірностей хвороб :"
label8 = Label()
label8['text'] = "Ascariasis :"
label9 = Label()
label9['text'] = "Hepatitis :"
label10 = Label()
label10['text'] = "Stones :"
label11 = Label()
label11['text'] = "0"
...
def definition_diagnosis(event):
    ...
    Sympthoms_1 = np.zeros((6, 4))
    Sympthoms_2 = np.zeros((6, 4))
    Sympthoms_3 = np.zeros((6, 4))
    ...
    # Обробки даних для Hepatitis та Stones так само
    ...
    Age_1 = int(edit1.get())
    vomit_1 = edit2.get()
    yellowness_1 = edit3.get()
    pain_1 = edit4.get()
    liver_1 = edit5.get()
    appetite_1 = edit6.get()
    ...
    label11['text'] = round(PrDKx[0], 2)
    label12['text'] = round(PrDKx[1], 2)
    label13['text'] = round(PrDKx[2], 2)
...
button1.bind('<Button-1>', definition_diagnosis)

edit1.place(x=400, y=90)
edit2.place(x=400, y=120)
edit3.place(x=400, y=150)
edit4.place(x=400, y=180)
edit5.place(x=400, y=210)
edit6.place(x=400, y=240)
button1.place(x=300, y=280)

label1.place(x=360, y=90, width=30)
label2.place(x=330, y=120, width=60)
label3.place(x=300, y=150, width=90)
label4.place(x=160, y=180, width=230)
label5.place(x=240, y=210, width=150)
label6.place(x=330, y=240, width=70)

label7.place(x=300, y=330, width=210)
label8.place(x=230, y=360, width=80)
label9.place(x=370, y=360, width=60)
label10.place(x=500, y=360, width=50)
label11.place(x=170, y=380, width=200)
label12.place(x=300, y=380, width=200)
label13.place(x=420, y=380, width=200)
